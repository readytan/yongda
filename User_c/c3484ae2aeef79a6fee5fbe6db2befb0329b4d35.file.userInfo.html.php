<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-29 22:09:17
         compiled from "F:\PHP\yongda\yongda\Application\View\Home\User\userInfo.html" */ ?>
<?php /*%%SmartyHeaderCode:124335518078d481f99-18235355%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '124335518078d481f99-18235355',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5518078d55cbc5_63063448',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5518078d55cbc5_63063448')) {function content_5518078d55cbc5_63063448($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'F:\\PHP\\yongda\\yongda\\Application\\libs\\plugins\\function.html_options.php';
                                ...
                                <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                                    <tr>
                                        ...
                                        <td width="72%" align="left" bgcolor="#FFFFFF"> 
                                            <select name="birthdayYear"><option value="1955">1955</option><option value="1956">1956</option><option value="1957">1957</option><option value="1958">1958</option><option value="1959">1959</option><option value="1960">1960</option><option value="1961">1961</option><option value="1962">1962</option><option value="1963">1963</option><option value="1964">1964</option><option value="1965">1965</option><option value="1966">1966</option><option value="1967">1967</option><option value="1968">1968</option><option value="1969">1969</option><option value="1970">1970</option><option value="1971">1971</option><option value="1972">1972</option><option value="1973">1973</option><option value="1974">1974</option><option value="1975">1975</option><option value="1976">1976</option><option value="1977">1977</option><option value="1978">1978</option><option value="1979">1979</option><option value="1980">1980</option><option value="1981">1981</option><option value="1982">1982</option><option value="1983">1983</option><option value="1984">1984</option><option value="1985">1985</option><option value="1986">1986</option><option value="1987">1987</option><option value="1988">1988</option><option value="1989">1989</option><option value="1990">1990</option><option value="1991">1991</option><option value="1992">1992</option><option value="1993">1993</option><option value="1994">1994</option><option value="1995">1995</option><option value="1996">1996</option><option value="1997">1997</option><option value="1998">1998</option><option value="1999">1999</option><option value="2000">2000</option><option value="2001">2001</option><option value="2002">2002</option><option value="2003">2003</option><option value="2004">2004</option><option value="2005">2005</option><option value="2006">2006</option><option value="2007">2007</option><option value="2008">2008</option><option value="2009">2009</option><option value="2010">2010</option><option value="2011">2011</option><option value="2012">2012</option><option value="2013">2013</option><option value="2014">2014</option><option value="2015">2015</option><option value="2016">2016</option></select>&nbsp;
                                            <select name="birthdayMonth"><option value="1">01</option><option value="2">02</option><option value="3">03</option><option value="4">04</option><option value="5">05</option><option value="6">06</option><option value="7">07</option><option value="8">08</option><option value="9">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>&nbsp;
                                            <select name="birthdayDay"><option value="1">01</option><option value="2">02</option><option value="3">03</option><option value="4">04</option><option value="5">05</option><option value="6">06</option><option value="7">07</option><option value="8">08</option><option value="9">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="72%" align="left" bgcolor="#FFFFFF">
                                            <input name="email" type="text" value="<?php echo '<?php'; ?>
...
" size="25" class="inputBg" />
                                    ...
                                    <tr>
                                        ...
                                        <td width="72%" align="left" bgcolor="#FFFFFF">
                                            <input name="extend_field2" type="text" class="inputBg" value="<?php echo '<?php'; ?>
 echo $row['qq'];<?php echo '?>'; ?>
"/>
                                            <span style="color:#FF0000"> *</span>			</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="72%" align="left" bgcolor="#FFFFFF">
                                            <input name="extend_field3" type="text" class="inputBg" value="<?php echo '<?php'; ?>
 echo $row['phone'];<?php echo '?>'; ?>
"/><span style="color:#FF0000"> *</span>			</td>
                                    </tr>
                                     <tr>
                                        <td width="28%" align="right" bgcolor="#FFFFFF" id="extend_field4i">学历：</td>
                                        <td width="72%" align="left" bgcolor="#FFFFFF">
                                            <select name="grade" id="User_user_xueli">
                                                <option value="1" selected="selected">-请选择-</option>
                                                <option value="2" selected="<?php echo '<?php'; ?>
 echo $row['grade']==2?'selected':'';<?php echo '?>'; ?>
">小学</option>

                                                <option value="3" selected="<?php echo '<?php'; ?>
 echo $row['grade']==3?'selected':'';<?php echo '?>'; ?>
">初中</option>
                                                <option value="4" selected="<?php echo '<?php'; ?>
 echo $row['grade']==4?'selected':'';<?php echo '?>'; ?>
">高中</option>
                                                <option value="5" selected="<?php echo '<?php'; ?>
 echo $row['grade']==5?'selected':'';<?php echo '?>'; ?>
">大学</option>
                                     ...
                                     <tr>
                                        ...
                                        <td width="72%" align="left" bgcolor="#FFFFFF">
                                             <input id="User_user_hobby_0" value="1" type="checkbox" name="basket" checked="<?php echo '<?php'; ?>
 echo $row['basketball']==1?'checked':'';<?php echo '?>'; ?>
" /> 
                                            <label for="User_user_hobby_0">篮球</label>&nbsp;
                                            <input id="User_user_hobby_1" value="2" type="checkbox" name="football" checked="<?php echo '<?php'; ?>
 echo $row['football']==1?'checked':'';<?php echo '?>'; ?>
"/> 
                                            <label for="User_user_hobby_1">足球</label>&nbsp;
                                            <input id="User_user_hobby_2" value="4" type="checkbox" name="volleyball" checked="<?php echo '<?php'; ?>
 echo $row['volleyball']==1?'checked':'';<?php echo '?>'; ?>
"/> 
                                            <label for="User_user_hobby_2">排球</label>&nbsp;
                                            <input id="User_user_hobby_3" value="8" type="checkbox" name="baseball" checked="<?php echo '<?php'; ?>
 echo $row['baseball']==1?'checked':'';<?php echo '?>'; ?>
"/> 
                                            <label for="User_user_hobby_3">棒球</label><span style="color:#FF0000"> *</span>			</td>
                                    </tr>
                                     <tr>
                                        <td width="28%" align="right" bgcolor="#FFFFFF" id="extend_field4i">简介：</td>
                                        <td width="72%" align="left" bgcolor="#FFFFFF">
                                            <textarea cols="50" rows="5" name="intro" id="User_user_introduce" ><?php echo '<?php'; ?>
 echo $row['intro'];<?php echo '?>'; ?>
</textarea> *</span>			</td>
                                    </tr>
                                    <tr>
